...
;(kcMessages as any)["en"] = {
  ...
  "deletingAccountForbidden": "Nimate pravic za brisanje lastnega računa, prosimo kontaktirajte skrbnika.",
  "kerberosNotConfigured": "Kerberos ni nastavljen",
  "kerberosNotConfiguredTitle": "Kerberos ni nastavljen",
  "bypassKerberosDetail": "Ali niste prijavljeni s Kerberos ali pa vaš brskalnik prijave s Kerberos ne omogoča.  Prosimo kliknite nadaljuj da se prijavite na drugačen način",
  ...
  "termsText": "<p>Splošni pogoji</p>",
  "termsPlainText": "Splošni pogoji",
  ...
  "loginTotpIntro": "Nastaviti si morate generator enkratnih gesel za dostop do tega profila",
  "loginTotpStep1": "Na svojo mobilno napravo namestite eno od naslednjih aplikacij:",
  "loginTotpStep2": "Odprite aplikacijo in z mobilno napravo odčitajte barcodo:",
  "loginTotpStep3": "Vpišite enkratno geslo, ki ga je ustvarila aplikacija in nato kliknite gumb za potrditev.",
  "loginTotpStep3DeviceName": "Za lastno evidenco vpišite prepoznavno ime za mobilno napravo s katero ste generirali enkratna gesla.",
  "loginTotpManualStep2": "Odprite aplikacijo in vpišite ključ:",
  "loginTotpManualStep3": "Vpišite naslednje vrednosti v nastavitve aplikacije, če le ta omogoča nastavljanje z vnosom vrednosti.",
  ...
  "inResource": "v",
  "emailVerifyInstruction1": "Poslana vam je bila e-pošta z navodili za potrditev veljavnosti e-naslova.",
  ...
  "emailLinkIdp1": "Poslana vam je bila e-pošta z navodili za povezavo {0} računa {1} z vašim {2} računom.",
  ...
  "emailInstruction": "Vpišite svoje uporabniško ime ali e-naslov in poslali vam bomo navodila za ponastavitev gesla.",
  "copyCodeInstruction": "Prosimo skopirajte prikazano šifro in jo uporabite v vaši aplikaciji:",
  ...
  "accountDisabledMessage": "Uporabniški račun je onemogočen, za pomoč kontaktirajte skrbnike sistema.",
  "accountTemporarilyDisabledMessage": "Uporabniški račun je začasno onemogočen, za pomoč kontaktirajte skrbnike sistema ali pa poskusite kasneje.",
  "expiredCodeMessage": "Prijava je potekla. Prosimo, da se ponovno prijavite.",
  "expiredActionMessage": "Čas za zahtevani postopek je potekel. Prosimo, da nadaljujete na prijavo.",
  "expiredActionTokenNoSessionMessage": "Čas za zahtevani postopek je potekel.",
  "expiredActionTokenSessionExistsMessage": "Čas za zahtevani postopek je potekel. Poskusite znova.",
  ...
  "invalidPasswordBlacklistedMessage": "Neustrezno geslo - geslo je na seznamu nedovoljenih gesel.",
  ...
  "emailExistsMessage": "E-pošta je že uporabljena pri enem od obstoječih uporabniških računov.",
  "federatedIdentityExistsMessage": "Uporabnik z {0} {1} že obstaja. Prosimo, da se prijavite v vmesnik za povezovanje sorodnih računov.",
  "confirmLinkIdpTitle": "Uporabniški račun že obstaja",
  "federatedIdentityConfirmLinkMessage": "Uporabniški račun z {0} {1} že obstaja. Več uporabniških računov z enakim e-naslovom ne dopuščamo. Kako želite nadaljevati?",
  "federatedIdentityConfirmReauthenticateMessage": "Prijava in združitev z uporabniškim računom {0}",
  "nestedFirstBrokerFlowMessage": "{0} uporabnik {1} ni povezan z obstoječim uporabniškim računom.",
  "confirmLinkIdpReviewProfile": "Pregled podrobnosti obstoječega računa",
  "confirmLinkIdpContinue": "Združi z obstoječim računom",
  "configureTotpMessage": "Prosimo, da na svoj mobilnik namestite aplikacijo za preverjanje v dveh korakih (npr. Authy).",
  "updateProfileMessage": "Prosimo, da dopolnite podatke svojega uporabniškega računa.",
  "updatePasswordMessage": "Preden omogočimo vaš uporabniški račun, prosimo, da nastavite novo geslo.",
  "resetPasswordMessage": "Prosimo nastavite novo geslo.",
  "verifyEmailMessage": "Preden omogočimo vaš uporabniški račun, prosimo da potrdite veljavnost vašega e-poštnega naslova.",
  "linkIdpMessage": "Prosimo potrdite veljavnost svojega e-naslova, da povežete svoj uporabniški račun in {0}.",
  "emailSentMessage": "Poslali smo vam e-pošto z nadaljnjimi navodili.",
  "emailSendErrorMessage": "Pošiljanje e-pošte je spodletelo, prosimo poskusite kasneje.",
  "accountUpdatedMessage": "Spremembe vašega uporabniškega računa so bile shranjene.",
  "accountPasswordUpdatedMessage": "Geslo za vaš uporabniški račun je bilo uspešno spremenjeno.",
  "delegationCompleteHeader": "Prijava je uspela",
  "delegationCompleteMessage": "To okno spletnega brskalnika lahko zaprete in nadaljujete postopek v prvotni aplikaciji.",
  "delegationFailedHeader": "Prijava ni uspela",
  "delegationFailedMessage": "To okno spletnega brskalnika lahko zaprete, se vrnete v izhodiščno aplikacijo in poskusite znova.",
  "noAccessMessage": "Dostop ni mogoč",
  "invalidPasswordMinLengthMessage": "Neustrezno geslo - najmanjše dovoljeno število znakov za geslo je {0}.",
  "invalidPasswordMinDigitsMessage": "Neustrezno geslo - vsebovati mora vsaj {0} številk.",
  "invalidPasswordMinLowerCaseCharsMessage": "Neustrezno geslo - vsebovati mora vsaj {0} malih črk.",
  "invalidPasswordMinUpperCaseCharsMessage": "Neustrezno geslo - vsebovati mora vsaj {0} velikih črk.",
  "invalidPasswordMinSpecialCharsMessage": "Neustrezno geslo - vsebovati mora vsaj {0} posebnih znakov.",
  "invalidPasswordNotUsernameMessage": "Neustrezno geslo - uporabniško ime in geslo ne smeta biti enaka.",
  "invalidPasswordNotEmailMessage": "Neustrezno geslo - e-pošta in geslo ne smeta biti enaka.",
  "invalidPasswordRegexPatternMessage": "Neustrezno geslo - ne ustreza predpisanemu vzorcu.",
  "invalidPasswordHistoryMessage": "Neustrezno geslo - ne sme biti enako, kot predhodno uporabljena gesla ({0}).",
  "invalidPasswordGenericMessage": "Neustrezno geslo - oblika gesla ne ustreza varnostnim zahtevam.",
  ...
  "differentUserAuthenticated": "Trenutno ste že prijavljeni kot uporabnik {0}. Za nadaljevanje kot drug uporabnik, se prosimo najprej odjavite iz trenutne seje.",
  "brokerLinkingSessionExpired": "Prišlo je do napake pri povezovanju računov - veljavnost trenutne seje je potekla.",
  ...
  "console-verify-email": "Vaš e-mail naslov je potrebno potrditi.  Na {0} smo vam poslali e-pošto, ki vsebuje potrditveno kodo. Potrditveno kodo, ki ste jo prejeli vnesite spodaj.",
