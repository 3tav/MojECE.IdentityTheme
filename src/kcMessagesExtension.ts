...
!(kcMessages as any)["sl"] &&
  ((kcMessages as any)["sl"] = {
    ...
    errorTitle: "Opravičujemo se...",
    errorTitleHtml: "Opravičujemo se ...",
    ...
    loginTotpStep2:
      "Odprite aplikacijo in z mobilno napravo odčitajte barcodo:",
    loginTotpStep3:
    ...
    invalidPasswordConfirmMessage:
      "Potrditveno geslo ni enako vpisanemu geslu.",
